...
export default function App() {
  ...
  const [selected, setSelected] = useState(resources[0]?.name || "users");
    ...
    <div className="app">
      ...
      <div className="layout">
        <nav className="sidebar">
          <div style={{ padding: "8px 12px", fontSize: "11px", fontWeight: 700, color: "#94a3b8", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "4px" }}>
            Database Resources
          </div>
